      ...
      <div className="text-center max-w-md px-4">
        ...
        {portal.activeModules.length === 0 ? (
          ...
          <div className="text-muted-foreground">
            ...
            <Link
              to="/setup"
              className="mt-4 inline-flex items-center justify-center rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 transition-colors"
            >
              Go to Setup
            </Link>
          </div>
