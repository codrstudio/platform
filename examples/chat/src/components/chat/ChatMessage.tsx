...
function MermaidBlock({ code }: { code: string }) {
  const ref = useMermaid(code, 'light') // TODO: detectar tema dark/light do sistema
  return <div ref={ref} className="mermaid-diagram my-4 p-2 bg-white dark:bg-nic-secondary-dark rounded border border-gray-200 dark:border-gray-700" />
}
