-- =============================================
-- Procedure: sac.test_jsql__mutate__chamado
-- Testa que a procedure REAL existe
-- =============================================

IF OBJECT_ID(N'sac.test_jsql__mutate__chamado', N'P') IS NULL
BEGIN
    EXEC('CREATE PROCEDURE sac.test_jsql__mutate__chamado AS SELECT 1');
END
GO

ALTER PROCEDURE sac.test_jsql__mutate__chamado
AS
BEGIN
    SET NOCOUNT ON;
    ...
    BEGIN TRY
        SET @error = NULL;
        IF OBJECT_ID(N'sac.jsql__mutate__chamado', N'P') IS NULL
    ...
    PRINT '================================================';
    PRINT 'SUMÁRIO: sac.test_jsql__mutate__chamado';
    PRINT '================================================';
