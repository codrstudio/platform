-- =============================================
-- Procedure: sac.test_jsql__select__cliente
-- TESTE REAL v4: Detecta bugs de OFFSET com múltiplos filtros
-- USA: id_cliente + ativo + LIMIT + OFFSET + ORDER BY
-- =============================================

IF OBJECT_ID(N'sac.test_jsql__select__cliente', N'P') IS NULL
BEGIN
    EXEC('CREATE PROCEDURE sac.test_jsql__select__cliente AS SELECT 1');
END
GO

ALTER PROCEDURE sac.test_jsql__select__cliente
AS
BEGIN
    SET NOCOUNT ON;
    ...
    -- =============================================
    BEGIN TRY
        EXEC sac.jsql__select__cliente
            @jsql = N'{"select":"cliente","where":{"id_cliente":{"gt":0},"ativo":{"eq":true}},"options":{"limit":5,"offset":1,"orderBy":"id_cliente","orderDirection":"DESC"}}',
    ...
    PRINT '================================================';
    PRINT 'SUMÁRIO: sac.test_jsql__select__cliente';
    PRINT '================================================';
