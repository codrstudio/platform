-- =============================================
-- Procedure: sac.test_jsql__select__usuario
-- TESTE REAL v4: Detecta bugs de OFFSET com múltiplos filtros
-- USA: id_usuario + ativo + LIMIT + OFFSET + ORDER BY
-- =============================================

IF OBJECT_ID(N'sac.test_jsql__select__usuario', N'P') IS NULL
BEGIN
    EXEC('CREATE PROCEDURE sac.test_jsql__select__usuario AS SELECT 1');
END
GO

ALTER PROCEDURE sac.test_jsql__select__usuario
AS
BEGIN
    SET NOCOUNT ON;
    ...
    BEGIN TRY
        EXEC sac.jsql__select__usuario
            @jsql = N'{"select":"usuario","where":{"id_usuario":{"gt":0},"ativo":{"eq":true}},"options":{"limit":5,"offset":1,"orderBy":"id_usuario","orderDirection":"DESC"}}',
    ...
    PRINT '================================================';
    PRINT 'SUMÁRIO: sac.test_jsql__select__usuario';
    PRINT '================================================';
